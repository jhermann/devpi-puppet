...
#
# [*www_port*]
# Port for external HTTP service endpoint; this is only used when the optional
# devpi::nginx class is added to your node. Set to undef to get an SSL only server.
# Defaults to 31415
#
# [*ssl_port*]
# Port for external HTTPS service endpoint; this is only used when the optional
# devpi::nginx class is added to your node. Set to undef to disable HTTPS.
# Defaults to 31443
#
# [*theme*]
...
class devpi (
    ...
    $ssl_port                   = $devpi::params::ssl_port,
    $theme                      = $devpi::params::theme,
    $master_fqdn                = $devpi::params::master_fqdn,
    $master_scheme              = $devpi::params::master_scheme,
